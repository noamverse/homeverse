...
export const features = [
  ...
  // ── FOUNDER ROWS ─────────────────────────────────────────────────────────────
  {
    ...
    heroImage: "/images/features/placeholder.jpg",
    body: [
      "Placeholder first paragraph for this founder feature. The editorial voice here is measured, warm, and curious.",
      "A second paragraph exploring the founder's worldview and the relational logic behind what they build.",
      "A closing reflection on why this person matters to the larger story HOME is telling.",
    ],
  },
  {
    ...
    heroImage: "/images/features/placeholder.jpg",
    body: [
      "Placeholder first paragraph for this founder feature. A conversation rather than a portrait — two people finding the edge of an idea together.",
      "A second paragraph where the interview turns toward something unexpected: a failure, a belief, a refusal.",
      "A closing paragraph that stays with the reader after the page closes.",
    ],
  },
  {
    ...
    heroImage: "/images/features/placeholder.jpg",
    body: [
      "Placeholder first paragraph for this founder feature. A builder in the truest sense — someone who reaches for form before they have the language for it.",
      "A second paragraph about what they are actually making, described from the inside.",
      "A closing reflection on what it takes to build something that will outlast you.",
    ],
  },
  {
