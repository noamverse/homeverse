...
export const stories = [
  ...
  body: [
    ...
    "And yet, he knows that what he is building does not adhere to external measurements.",
    ...
    "He will not be on that couch much longer. The trajectory has already turned. Entrepreneurs from around the world are asking him to build relational infrastructure, a thesis he had not even publicly articulated before they began arriving. There is a partnership with the most consequential AI company of this era, formed without him asking for it, because the technology recognized the soul before the soul recognized itself. All of this is happening, simultaneously, around a man who cannot even order an Uber.",
